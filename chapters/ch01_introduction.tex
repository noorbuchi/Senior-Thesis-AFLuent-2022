...
\begin{figure}[!htb]
	\begin{center}
		...
		\caption{\label{fig:sfl_example} Applied Example of SFL Equations}
	\end{center}
\end{figure}
...
Overall limitations of SFL will be discussed in Related Works and acknowledged
