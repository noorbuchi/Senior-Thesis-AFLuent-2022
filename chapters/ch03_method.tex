...
% TODO: add cyclomatic complexity citation
...
density of the statement is 2, which is also its tiebreaking score. Note that
variable assignment and literals do not affect logical tiebreaking scores.
Lastly, enhanced tiebreaking takes into consideration a more extensive list of
